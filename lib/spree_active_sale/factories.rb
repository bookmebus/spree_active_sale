  ...
  factory :active_sale, :class => Spree::ActiveSale do
    ...
    factory :active_sale_with_events do
      ...
      after(:create) do |sale, evaluator|
        FactoryBot.create_list(:active_sale_event, evaluator.events_count, :active_sale => sale, :is_active => evaluator.active, :is_hidden => evaluator.hidden, :is_permanent => evaluator.permanent, :single_product_sale => evaluator.single_product_sale)
      end
